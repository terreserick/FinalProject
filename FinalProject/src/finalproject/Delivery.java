...
public class Delivery extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Menu de busca de items para o Brecho");

        jLabel2.setText("Pedir infos de localização e exibir uma mensagem de confimação");

        jLabel3.setText("Também Pedir o tipo da Roupa (Info da db, pode criar se quiser)");
